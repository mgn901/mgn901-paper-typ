...
#let paper(
  ...
  context {
      ...
      .fold(
        ...
        (it, i) => {
          ...
          show heading.where(level: i + 1): paper-heading.with(
            ...
            heading-font-settings: font-setting,
    ...
    show: common-page.with(..page-settings, ..type-settings.default)
    ...
    show: paper-table.with(type-settings: type-settings.small, font-settings: font-settings.small)
